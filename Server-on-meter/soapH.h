/* soapH.h
   Generated by gSOAP 2.8.120 for xml-rpc.h
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__boolean(soap, p, "boolean", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__i4(soap, p, "i4", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__int(soap, p, "int", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__double(soap, p, "double", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_methodCall(soap, p), 0) || ::soap_put_methodCall(soap, p, "methodCall", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_methodCall(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
...
{
	if (::soap_read_methodCall(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_fault(soap, p), 0) || ::soap_put_fault(soap, p, "fault", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_fault(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_methodResponse(soap, p), 0) || ::soap_put_methodResponse(soap, p, "methodResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_methodResponse(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
...
{
	if (::soap_read_methodResponse(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
#endif
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_param(soap, p), 0) || ::soap_put_param(soap, p, "param", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_param(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_params(soap, p), 0) || ::soap_put_params(soap, p, "params", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_params(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize__array(soap, p), 0) || ::soap_put__array(soap, p, "array", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__array(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_data(soap, p), 0) || ::soap_put_data(soap, p, "data", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_data(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_member(soap, p), 0) || ::soap_put_member(soap, p, "member", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_member(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize__struct(soap, p), 0) || ::soap_put__struct(soap, p, "struct", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__struct(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
...
{
	if (::soap_read__struct(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
#endif

#ifndef SOAP_TYPE__rawdata_DEFINED
#define SOAP_TYPE__rawdata_DEFINED
...
{
	return soap_instantiate__rawdata(soap, n, NULL, NULL, NULL);
}

inline struct _rawdata * soap_new_req__rawdata(
	struct soap *soap)
{
	struct _rawdata *_p = ::soap_new__rawdata(soap);
	if (_p)
	{	::soap_default__rawdata(soap, _p);
	}
	return _p;
}
...
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize__rawdata(soap, p), 0) || ::soap_put__rawdata(soap, p, "rawdata", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize__rawdata(soap, p), 0) || ::soap_put__rawdata(soap, p, "rawdata", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize__rawdata(soap, p), 0) || ::soap_put__rawdata(soap, p, "rawdata", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize__rawdata(soap, p), 0) || ::soap_put__rawdata(soap, p, "rawdata", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (p)
	{	::soap_default__rawdata(soap, p);
		if (soap_begin_recv(soap) || ::soap_get__rawdata(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__rawdata(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize__base64(soap, p), 0) || ::soap_put__base64(soap, p, "base64", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read__base64(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_value(soap, p), 0) || ::soap_put_value(soap, p, "value", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_value(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
...
#ifndef SOAP_TYPE_PointerTo_rawdata_DEFINED
#define SOAP_TYPE_PointerTo_rawdata_DEFINED
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__dateTime_DOTiso8601(soap, p, "dateTime.iso8601", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || ::soap_put__string(soap, p, "string", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
