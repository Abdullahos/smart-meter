...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.120 2022-04-18 09:26:18 GMT")
...
#ifndef WITH_NOIDREF
	if (a->__ptr)
		(void)soap_array_reference(soap, a, a->__ptr, a->__size, SOAP_TYPE__rawdata);
#endif
}
...
{
	id = soap_element_id(soap, tag, id, a, a->__ptr, a->__size, type, SOAP_TYPE__rawdata, NULL);
	if (id < 0)
		return soap->error;
...
SOAP_FMAC3 struct _rawdata * SOAP_FMAC4 soap_in__rawdata(struct soap *soap, const char *tag, struct _rawdata *a, const char *type)
{
	...
	a = (struct _rawdata*)soap_id_enter(soap, soap->id, a, SOAP_TYPE__rawdata, sizeof(struct _rawdata), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct _rawdata *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE__rawdata, SOAP_TYPE__rawdata, sizeof(struct _rawdata), 0, soap_finsert, soap_fbase);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct _rawdata * SOAP_FMAC2 soap_instantiate__rawdata(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE__rawdata, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
...
{
	id = soap_element_id(soap, tag, id, *a, *a ? (*a)->__ptr : NULL, *a ? (*a)->__size : 0, type, SOAP_TYPE__rawdata, NULL);
	if (!*a || id < 0)
		return soap->error;
...
SOAP_FMAC3 struct _rawdata ** SOAP_FMAC4 soap_in_PointerTo_rawdata(struct soap *soap, const char *tag, struct _rawdata **a, const char *type)
{
	...
	*a = NULL;
	...
	{	a = (struct _rawdata **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__rawdata, sizeof(struct _rawdata), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
